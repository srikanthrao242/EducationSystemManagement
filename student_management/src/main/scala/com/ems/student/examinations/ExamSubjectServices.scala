...
trait ExamSubjectServices {
  implicit val examinations_subjectsDao: Dao.Aux[Examinations_Subjects, Int] =
    Dao.derive[Examinations_Subjects, Int]("examination_subjects", "SubjectID")
  implicit val examinations_subjectsShow: Show[Examinations_Subjects] = Show.fromToString
  val examinations_subjectsDn: Aux[Examinations_Subjects, Int] = Dao[Examinations_Subjects]
