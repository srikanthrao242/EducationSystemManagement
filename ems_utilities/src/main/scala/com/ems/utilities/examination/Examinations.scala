...
case class Examinations_Details(ExamID: Option[Int], sectionID:Option[Int], ExamName: String, ExamFor: Int, TotalMarks: Int, ExamDate: Date, CreatedDate: Date, AcademicID:Int)
...
object ExaminationsSer{
  ...
  implicit val examinations_DetailsF: RootJsonFormat[Examinations_Details] = jsonFormat8(Examinations_Details)
